...
### modified by dave.herzig@gmail.com 2016/10/25
### script is now working if the sequence starts with N
...
#   print SCAFF_FILE ">$supercontig_id\n$supercontig_seq\n";
   ...
   #print "SUPERCONTIG_SEQ: $supercontig_seq \n";
   FORLOOP: foreach my $substring_sequence ( split /(N+)/i, $supercontig_seq ) {
   #print "SUBSTRING_SEQUENCE: $substring_sequence \n";
   #warn "\n$substring_sequence\n" if $supercontig_id eq '1160'; for #debugging only

   next FORLOOP if $substring_sequence eq "";
